...
Plans:
- [ ] 02-01-PLAN.md — Data model extension, provider abstraction, encrypted key storage
- [ ] 02-02-PLAN.md — AI provider settings UI, first-use setup modal
...
| 2. AI Task Breakdown | 0/5 | Planned | - |
